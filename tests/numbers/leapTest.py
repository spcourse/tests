...
def leapYears100():
	...
	assert expected == actual, "Did you implement a rule such that every 100th year is not a leap year?"
...
def leapYears400():
	...
	assert expected == actual, "Did you implement a rule such that every 400th year is a leap year?"
...
def handlesEqualYears():
    ...
    assert expected == actual, "Did you ensure that the program asks for a new last year when the first year is equal to the last year?"
...
def handlesDecreasingYears():
    ...
    expected = [2000, 2004, 2008]
    actual =  sorted(set(static.getNumbersFrom(result)))
    assert expected == actual, "Did you ensure that the program asks for a new last year when the first year is greater than the last year?"
...
def leapYearAt400Boundary():
    ...
    expected = [2400]
    actual =  sorted(set(static.getNumbersFrom(result)))
    assert expected == actual, "Did you implement the rule that every 400th year is a leap year?"
...
def nonLeapYearAt100Boundary():
    ...
    expected = []
    actual =  sorted(set(static.getNumbersFrom(result)))
    assert expected == actual, "Did you implement the rule that every 100th year is not a leap year, unless it is a 400th year?"
