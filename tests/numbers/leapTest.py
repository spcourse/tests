...
def leapYears100(test):
	...
	test.fail = lambda d: "Did you implement a rule such that every 100th year is not a leap year?"
	test.timeout = lambda : 90
...
def leapYears400(test):
	...
	test.fail = lambda d: "Did you implement a rule such that every 400th year is a leap year?"
	test.timeout = lambda : 90
