...
def sandbox():
	lib.require("pos_words.txt", "https://sp1.mprog.nl/materials/text/en/sentiment/pos_words.txt")
	lib.require("neg_words.txt", "https://sp1.mprog.nl/materials/text/en/sentiment/neg_words.txt")
